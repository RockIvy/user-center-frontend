...
import { currentUser as queryCurrent, updateLoginUser } from '@/services/ant-design-pro/api';
          ...
          <div className={styles.left}>
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <ProFormText width="md" name="phone" label="电话" disabled={modifyPhone} />
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <ProFormText width="md" name="email" label="邮箱" disabled={modifyEmail} />
                {modifyEmail ? (
                  <span style={{ marginLeft: '15px' }}>
                    <a
                      key="Modify"
